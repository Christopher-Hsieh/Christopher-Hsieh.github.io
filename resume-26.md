...
Senior full-stack engineer and platform lead with 10+ years of experience. Set technical direction across engineering teams and partner with business leadership on architecture and strategy — while remaining hands-on from proof-of-concept through production. Recent focus: Nike.com's web platform and the platform powering Nike's retail store operations.
...
- Frontend: React, Next.js, Vite, HTML, CSS, Webpack, Micro-frontends, Module Federation
- Backend & APIs: Node.js, Spring Boot, Maven, REST APIs, GraphQL
- Cloud & Infrastructure: AWS, CloudFront, Route 53, CDK, S3, Lambda, RDS, OpenSearch, Docker
- CI/CD, Testing & Quality: Jenkins, GitHub Actions, Jest, Testing Library, JUnit, Sonar
- Observability: New Relic, Splunk, AppDynamics
- Identity & Security: OAuth, Okta, Ping Identity, custom identity providers
- Leadership: Platform architecture, technical strategy, cross-functional partnership, engineering standards, developer enablement, delivery ownership
